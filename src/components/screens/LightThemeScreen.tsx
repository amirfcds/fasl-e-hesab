...
export const LightThemeScreen = () => (
  <div className="theme-light min-h-full pb-24 bg-background text-foreground">
    <StatusBar />
    <div className="app-header">
      ...
      <div className="text-center">
        ...
        <h1 className="text-sm font-bold">علی رضایی ☀️</h1>
      </div>
    ...
    <div className="px-5">
      <div className="app-card hero-bg p-5">
        <p className="text-[11px] text-muted-foreground">خلاصه وضعیت — تم روشن</p>
      ...
      <div className="space-y-2.5">
        {[
          { t: "سفر شمال", s: "۵ عضو • ۱۲ هزینه", a: "- ۴۸۰,۰۰۰", cls: "text-destructive" },
          { t: "خانواده", s: "۴ عضو • ۴۳ هزینه", a: "+ ۲۲۰,۰۰۰", cls: "text-accent" },
        ].map((x, i) => (
